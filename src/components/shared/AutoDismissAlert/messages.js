const messages = {
	...
	getBooksFailure: "Can't connect to the database...",
	createBookSuccess: 'Book added to Tagged Books page!',
	createBookFailure: 'Something went wrong, could not add that to Tagged Books...'
}
